...
public interface ConnectorInitializationContextBuilder {
    ...
    ConnectorInitializationContextBuilder processGroupFacadeFactory(ProcessGroupFacadeFactory processGroupFacadeFactory);

    ConnectorInitializationContextBuilder secretsManager(SecretsManager secretsManager);

    ConnectorInitializationContextBuilder configurationContext(ConnectorConfigurationContext connectorConfigurationContext);

    ConnectorInitializationContextBuilder parameterContextFacade(ParameterContextFacade parameterContextFacade);
