...
public interface NiFiConnectorWebContext {
     ...
     * @throws ResourceNotFoundException if the connector does not exist
     */
    <T> T getConnector(String connectorId) throws ResourceNotFoundException;

    /**
     * @return the current user identity. The value may be a DN, an email, a username, or any string that identifies the user.
