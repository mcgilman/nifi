...
public class StandardNiFiConnectorWebContext implements NiFiConnectorWebContext {
    ...
    public <T> T getConnector(final String connectorId) throws ResourceNotFoundException {
        final ConnectorNode connectorNode = connectorDAO.getConnector(connectorId);
        if (connectorNode == null) {
            throw new ResourceNotFoundException("Unable to find connector with id: " + connectorId);
        }
